...
#ifndef _ANT_ANTMOVEMENT_H
#define _ANT_ANTMOVEMENT_H
...
int** antAlgorithm ( int* x, int* y, int antCounter, int* heading, int** board, int boardSize, int handlingLenght, char* handling);
