...
int** antAlgorithm ( int* x, int* y, int antCounter, int* heading, int** board, int boardSize, int handlingLenght, char* handling) // funkcja odpowiadająca za cały algorytm mrówki
{
